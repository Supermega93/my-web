...
export const LEVEL3_LESSONS: Lesson[] = [
  {
    ...
    duration_minutes: 15,
    is_free: true,
    video_url: 'https://www.youtube.com/watch?v=qSFuZUI-y8U',
    video_id: 'qSFuZUI-y8U',
    video_title: 'Level 3 Masterclass: Robot Architecture & Blueprints',
    video_subtitle: 'Watch the visual guide to the 5 MQL5 program types and robot architecture before working through the lesson below.',
    video_badge: 'Level 3 Video Masterclass',
    content: `
