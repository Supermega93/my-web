...
export function Modal({
  ...
  return (
    <div 
      className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/75 backdrop-blur-md animate-fade-in"
      onClick={onClose}
    >
      <div className="min-h-full flex items-center justify-center p-4 sm:p-6 text-center">
        ...
        {/* Modal Dialog Card */}
        <div
          className={`relative w-full ${maxWidthClasses[maxWidth]} my-auto bg-slate-900/95 backdrop-blur-2xl border border-slate-800/80 rounded-3xl shadow-2xl overflow-hidden z-10 text-left max-h-[92vh] flex flex-col`}
